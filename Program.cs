...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Ex: gadhagoru@gmail.com; gadha-file-keya-karega@gmail.com");
            Console.WriteLine("");

            string Email = Console.ReadLine();
            // string Email = "gadhagoru@gmail.com; gadhagoru@gmail.com";
        ...
        public static void SendEmail(string Emails, string PathWhereToCopyTo)
        {
            try
            {
                ...
                MailAddress fromAddress = new MailAddress("gadhagoru@gmail.com", "OCCG Support");
                // var fromAddress = new MailAddress("gadhagoru@gmail.com", "OCCG Support");
